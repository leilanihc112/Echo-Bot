...
class Text(commands.Cog):
    ...
    @commands.command(name='get_time', help='Get current time')
    async def get_time(self, context):
        await context.channel.send(datetime.datetime.strftime(datetime.datetime.now(), "%A %m/%d/%Y %H:%M:%S"))
